...
export const ProvidersModal = ({
  ...
  // Calculate mock prices for display
  const providers = Object.values(providerData).map((provider) => ({
    ...provider,
    price: {
      source: amount || "50",
      destination:
        convertedAmount ||
        (
          parseFloat(amount || "50") / parseFloat(provider.exchangeRate)
        ).toFixed(2),
    },
  }));
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-gray-600">
                        ${provider.price.source} = {provider.price.destination}{" "}
                        {token}
                      </div>
