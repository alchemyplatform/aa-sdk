...
describe("MA v2 Tests", async () => {
  ...
  const response = {
    ...
    id: "uos_o2pAvyGp8IbhpP5Ha_ra2Mj5FCxMnB2i6VxYzQE",
    rawId: "uos_o2pAvyGp8IbhpP5Ha_ra2Mj5FCxMnB2i6VxYzQE",
    response: {
      authenticatorData: "SZYN5YgOjGh0NBcPZHZgW4_krrmihjLHmVzzuoMdl2MFAAAAAA",
      clientDataJSON:
        "eyJ0eXBlIjoid2ViYXV0aG4uZ2V0IiwiY2hhbGxlbmdlIjoiMHhlZjdlNTJiYTJiNWUwNjA1NGE1MTBlOWNjZDZiMDIyYmMyYzk4ZWM5NGJjZDdjODRiM2RlZmY2MmEyNzQ3MmR3Iiwib3JpZ2luIjoiaHR0cDovL2xvY2FsaG9zdDozMDAwIiwiY3Jvc3NPcmlnaW4iOmZhbHNlfQ",
      signature:
        "MEYCIQD5DEot70dln1RbwlghNrOHpTC2927j_t2YN8UtpZlglgIhAK3d1hIuIA3y4j854_PqKXUfrqqrMcTZe_AadX39oq5P",
  ...
  const credential = {
    id: response.id,
    publicKey:
      "0x3059301306072a8648ce3d020106082a8648ce3d03010703420004483fa099ff02884afb490205ae52daa004c72eff256d75c65139429d7e3e948296d323de72945d4738ace1381b7f9af5959e709237afdfdc353478004d66433f",
  } as const;
  ...
  console.log(webAuthnAccountParams);
