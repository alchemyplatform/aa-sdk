...
describe("MA v2 Tests", async () => {
  ...
  const credential = {
    id: "6U2zWip7YPv38-_XULCIFU--cKllTYviMSw4vFuCFl4",
    publicKey:
      "0x3059301306072a8648ce3d020106082a8648ce3d03010703420004524cb72f8051cb9c25baa5374d670493d23f6d8a34a8d4f31cbb6911b987fee033bafb98db845368aa776157a12eb1f41d1399ca9774e8cc931a9f52c4dfe7b6",
  } as const;
    ...
    getFn() {
      return Promise.resolve({
        response: {
          ...
          signature: [
            48, 70, 2, 33, 0, 228, 172, 54, 88, 121, 42, 147, 253, 18, 57, 255,
            180, 80, 128, 49, 106, 31, 119, 216, 133, 163, 44, 225, 146, 186,
            243, 127, 225, 96, 88, 37, 149, 2, 33, 0, 250, 157, 195, 109, 231,
            96, 227, 229, 5, 248, 228, 140, 115, 183, 156, 41, 69, 63, 99, 101,
            20, 192, 134, 153, 2, 133, 223, 155, 96, 156, 8, 70,
          ],
        },
      } as any);
    },
