    ...
    async (nft: boolean = false) => {
      ...
      try {
        ...
        const executeWithSessionKey =
          provider.isConnected<MSCA>() && sessionKeyEnabled && sessionKey;
        ...
        {provider.isConnected() && (
          <div className="flex flex-col flex-wrap gap-[12px]">
            ...
            {availablePlugins.map((plugin: Plugin<any, any>, i: number) => {
              ...
              const _pluginType = getPluginTypeFromAddress(
                pluginAddress as Address,
                provider.rpcClient.chain.id
              )!;
              return (
                ...
                >
                  ...
                  <button
                    disabled={
                      ...
                      pluginTxStatus !== null ||
                      installed ||
                      (!sessionKey && _pluginType === PluginType.SESSION_KEY)
                    }
                    onClick={() =>
                  ...
                  {pluginTxHash && pluginType === _pluginType && (
                    <a
