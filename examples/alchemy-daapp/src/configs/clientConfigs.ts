...
export const daappConfigurations: Record<number, DAAppConfiguration> = {
  [polygon.id]: {
    ...
    lightAccountFactoryAddress: getDefaultLightAccountFactory(polygon),
  ...
  [polygonMumbai.id]: {
    ...
    lightAccountFactoryAddress: getDefaultLightAccountFactory(polygonMumbai),
  ...
  [sepolia.id]: {
    nftContractAddress: "0x5679b0de84bba361d31b2e7152ab20f0f8565245",
    lightAccountFactoryAddress: getDefaultLightAccountFactory(sepolia),
  ...
  [arbitrum.id]: {
    nftContractAddress: "0xb7b9424ef3d1b9086b7e53276c4aad68a1dd971c",
    lightAccountFactoryAddress: getDefaultLightAccountFactory(arbitrum),
  ...
  [optimism.id]: {
    ...
    lightAccountFactoryAddress: getDefaultLightAccountFactory(optimism),
  ...
  [optimismGoerli.id]: {
    nftContractAddress: "0x835629117Abb8cfe20a2e8717C691905A4725b7c",
    lightAccountFactoryAddress: getDefaultLightAccountFactory(optimismGoerli),
  ...
  [base.id]: {
    nftContractAddress: "0x835629117Abb8cfe20a2e8717C691905A4725b7c",
    lightAccountFactoryAddress: getDefaultLightAccountFactory(base),
  ...
  [baseGoerli.id]: {
    nftContractAddress: "0x835629117Abb8cfe20a2e8717C691905A4725b7c",
    lightAccountFactoryAddress: getDefaultLightAccountFactory(baseGoerli),
