...
`v5.x.x` as source truth.

## Why

Local checkouts may contain untracked generated or experimental directories.
Those are not part of the v5 branch contract and should not influence scaffold
...
work and call out that it is not tracked on `v5.x.x`.
