          ...
          >
            ...
            >
              ...
              <div class="flex flex-row gap-[8px] justify-start items-center">
                <a rel="noopener noreferrer" href="./getting-started/embedded-accounts/setup.html">
                  <button
...
:::
        ...
        <div class="flex max-lg:flex-wrap justify-center gap-[32px]">
          ...
          <a rel="noopener noreferrer" href="./getting-started/embedded-accounts/setup.html" class="flex-auto basis-1/3 max-lg:max-w-[370px] max-lg:min-w-[370px]">
            <div
