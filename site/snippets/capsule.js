...
import Capsule, { Environment, createCapsuleViemClient, } from "@usecapsule/web-sdk";
...
export const capsuleSigner = new WalletClientSigner(capsuleClient, "capsule" // signerType
);
