...
::: details Do accounts have the same address across all chains?
...
::: details How would Alchemy initiate an upgrade of a LightAccount?
...
::: details Can I have multiple accounts for the same owner address? / How do I set the value of the salt/index for LightAccount?
...
::: details How does the speed of user operations compare to normal transactions?
...
::: details Why am I seeing a delay in landing userOps on-chain?
...
::: details Are user operations protected from MEV bots?
...
::: details Can I simulate user operations the same way I simulate transactions?
Yes! Check out [this guide](/tutorials/sim-user-operation.html).
:::

## Gas Estimation

::: details How does gas estimation for 4337 smart contract accounts work?
Our bundler estimates gas and submits User Operations under the hood of the aa-sdk. Our gas estimations are just that, estimations that optimize for user operations landing on chain, and you may need to adjust gas limits based on your needs using [overrides](/packages/aa-core/provider/types/userOperationOverrides.html). Learn more about gas estimation and how it is implemented in our [bundler](https://www.alchemy.com/blog/erc-4337-gas-estimation).
...
::: details What tiers support gas sponsorship?
...
::: details How is gas sponsored? Do I need to fund the gas manager?
...
::: details What are my gas sponsorship limits?
...
::: details Do you support ERC20 or stablecoin paymasters?
...
::: details How is the gas manager protected from DDOS attacks?
...
::: details What are precheck failed errors and how do I handle them?
...
::: details Total execution gas limit exceeded
...
::: details waitForUserOperationTransaction timeout
