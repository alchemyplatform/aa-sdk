...
description: Key Concpets and Examples of Smart Wallet Policies
---
...
9. **Multi-Factor Authentication (Offchain)**
    - Description: Mandate MFA via an authenicator app like Authy (off-chain).
    - Use Case: Add an extra security layer for user logins in a wallet.
10. **Chain Restrictions (Offchain)**
    - Description: Restrict wallet only transact on a limited set of chains.
