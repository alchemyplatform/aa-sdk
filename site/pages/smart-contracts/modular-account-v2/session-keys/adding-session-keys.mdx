...
await client.installValidation({
  validationConfig: {
    validationModule: ecdsaValidationModuleAddress,
...
```ts twoslash
import { createModularAccountV2Client } from "@account-kit/smart-contracts";
import { installValidationActions, getDefaultSingleSignerValidationModuleAddress, SingleSignerValidationModule, modularAccountAbi, getDefaultTimeRangeModuleAddress, TimeRangeModule } from "@account-kit/smart-contracts/experimental";
import { LocalAccountSigner } from "@aa-sdk/core";
import { sepolia, alchemy } from "@account-kit/infra";
import { generatePrivateKey } from "viem/accounts";
...
let sessionKeyEntityId = 1;
const ecdsaValidationModuleAddress = getDefaultSingleSignerValidationModuleAddress(chain)
const sessionKey: SmartAccountSigner = LocalAccountSigner.mnemonicToAccountSigner(
  "SESSION_KEY_MNEMONIC"
);
...
```ts twoslash
import { createModularAccountV2Client } from "@account-kit/smart-contracts";
import { installValidationActions, getDefaultSingleSignerValidationModuleAddress, SingleSignerValidationModule, modularAccountAbi, getDefaultPaymasterGuardModuleAddress, PaymasterGuardModule } from "@account-kit/smart-contracts/experimental";
import { LocalAccountSigner } from "@aa-sdk/core";
import { sepolia, alchemy } from "@account-kit/infra";
import { generatePrivateKey } from "viem/accounts";
...
```ts twoslash
import { createModularAccountV2Client } from "@account-kit/smart-contracts";
import { installValidationActions, getDefaultSingleSignerValidationModuleAddress, SingleSignerValidationModule, modularAccountAbi, getDefaultNativeTokenLimitModule, NativeTokenLimitModule } from "@account-kit/smart-contracts/experimental";
import { LocalAccountSigner } from "@aa-sdk/core";
import { sepolia, alchemy } from "@account-kit/infra";
import { generatePrivateKey } from "viem/accounts";
...
```ts twoslash
import { createModularAccountV2Client } from "@account-kit/smart-contracts";
import { installValidationActions, getDefaultSingleSignerValidationModuleAddress, SingleSignerValidationModule, modularAccountAbi, getDefaultAllowlistModuleAddress, AllowlistModule } from "@account-kit/smart-contracts/experimental";
import { LocalAccountSigner } from "@aa-sdk/core";
import { sepolia, alchemy } from "@account-kit/infra";
import { generatePrivateKey } from "viem/accounts";
import { parseEther } from "viem";
...
const hookEntityId = 0; // Make sure that the account does not have a hook with this entity id on the module yet
const allowlistInstallData = AllowlistLimitModule.encodeOnInstallData({
          entityId: hookEntityId,
