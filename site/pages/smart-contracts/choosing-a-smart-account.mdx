...
GOAL: Convince users to use MAv2.
HOW?: Show benchmarks, show features.
...
Beyond that, alchemy's Account Kit offers a simple & clean SDK to provide your users with top-tier smart account features. With Account Kit's most powerful, most natively-supported account being Modular Account V2. MAv2 is the world's most fully-featured and efficient smart account, allowing for limitless modular expansion while remaining maximally gas-efficient.
