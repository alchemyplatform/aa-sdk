...
A smart account is an [ERC-4337](https://eips.ethereum.org/EIPS/eip-4337) smart account. You can use it to manage assets, execute transactions (known as `UserOperation`s), and more. There are many different implementations of a smart account, including [Modular Account V2](/smart-contracts/modular-account-v2/), [Modular Account](/smart-contracts/other-accounts/modular-account/) and [Light Account](/smart-contracts/other-accounts/light-account/).
