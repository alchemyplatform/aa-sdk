...
If you are a developer without existing embedded wallet users, considering [using smart accounts ](/react-getting-started) from the start without EIP-7702. [Decide](https://www.alchemy.com/blog/eip-7702-ethereum-pectra-hardfork#for-developers-that-havent-yet-deployed-their-application) what's best for you!
