...
// [!include ~/shared/smart-contracts/other-accounts/light-account-client.ts]
```
...
See the [`LightAccount`](/smart-contracts/other-accounts/light-account/) docs for more details about our `LightAccount implementation.
