...
If your pamyaster supports the ERC-7677 standard, you can use the [`erc7677Middleware`](/reference/aa-sdk/core/functions/erc7677Middleware) to interact with it.
