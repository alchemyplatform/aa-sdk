...
The version of viem has been updated to `2.26.0` and been added as a peer dependency. If you have viem listed as a dependency, make sure it is updated to `2.26.0`.
