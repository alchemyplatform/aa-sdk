...
Account Kit provides pre-built UI components that handle the entire custom social provider authentication flow with minimal code. Follow the instructions in the [UI Components](/react/ui-components) documentation to set up the authentication modal or embedded auth card in your application.
...
### Configuring Custom Social Providers in UI Components

To customize the custom social provider experience in your pre-built components, configure the UI as follows:
