...
Account Kit provides pre-built UI components that handle the entire Passkey Login authentication flow with minimal code. Follow the instructions in the [UI Components](/react/ui-components) documentation to set up the authentication modal or embedded auth card in your application.

### Configuring Passkey Login in UI Components
