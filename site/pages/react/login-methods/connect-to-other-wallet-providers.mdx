---
title: Seamlessly Connect with Your Favorite Web3 Wallets
description: How to connect to other wallet providers using Account Kit
---

## Seamlessly Connect with Your Favorite Web3 Wallets

Easily log in using popular wallet providers like **MetaMask**, **Rabby**, **Phantom**, and more.

Thanks to our built-in wallet connectors, there's no need to integrate external solutions like RainbowKit.
We automatically detect and display all wallet extensions available in the user's browser—ensuring a smooth and flexible experience.

With Account Kit, users can still connect to their existing wallets without sacrificing compatibility or convenience.

<img src="/images/connect-to-other-wallet-providers.png" />

In order to access these external wallet providers, just make sure to include configure `walletConnect` in your config:
