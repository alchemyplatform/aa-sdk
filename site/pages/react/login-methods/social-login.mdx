...
If you want to require a second factor for Social Login, see [Social Login with Multi-Factor Authentication](/react/mfa/social-login). Once users have set up a TOTP-based authenticator app, they'll be prompted for their 6-digit code automatically.
