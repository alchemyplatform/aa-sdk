...
Account Kit provides pre-built UI components that handle the entire Social Login authentication flow with minimal code. Follow the instructions in the [UI Components](/react/ui-components) documentation to set up the authentication modal or embedded auth card in your application.

### Configuring Social Login in UI Components

To customize the Social Login authentication experience in your pre-built components, configure the UI as follows:
