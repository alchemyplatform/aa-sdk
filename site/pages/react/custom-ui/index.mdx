...
:::tip
Account Kit provides pre-built, [highly customizable UI components](/react/ui-components) that handle authentication with minimal code. Consider using these components before building custom UI!
:::
