...
:::tip
Account Kit provides [pre-built UI components](/react/ui-components) that handle social login authentication with minimal code. Consider using these components before building custom UI!
:::
