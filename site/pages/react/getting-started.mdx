...
- [Set up Multi-Factor Authentication](/react/mfa/setup-mfa) - Learn how to implement authenticator app verification for your users
- MFA works with Email OTP, Email Magic Link, and Social Login methods
- For pre-built UI components, MFA verification on login is handled automatically
- For custom UI implementations, additional code is needed to handle the MFA verification step on login
