...
Once your users have been [authenticated](/react/authentication-methods), you can start sending user operations! Account Kit makes it really easy to send user operations using React hooks.
