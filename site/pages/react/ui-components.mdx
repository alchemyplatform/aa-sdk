...
Account Kit allows you to use pre-built, [highly customizable](https://demo.alchemy.com/) UI components to handle authenticating your users. The way you use them is very flexible since you can use the pre-built modal or even embed the Auth card directly in your application.
