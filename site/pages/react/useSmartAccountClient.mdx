...
```ts [types.ts]
// [!include ~/../aa-sdk/accounts/src/light-account/accounts/account.ts:CreateLightAccountParams]
```
...
```ts [types.ts]
// [!include ~/../aa-sdk/accounts/src/msca/account/multiOwnerAccount.ts:CreateMultiOwnerModularAccountParams]
```
