...
import Snippet from "../../shared/setup-config.mdx";
...
## 1. Set up your Account config

For both new and existing projects, you'll create a new Account config to set your authentication methods.

<Snippet />

## New project

### 1. Set up your Account Kit config
...
### 2. Create a new NextJS app using our Account Kit template

For a simple end-to-end example, we will spin up a new NextJS app using our Account Kit template.
