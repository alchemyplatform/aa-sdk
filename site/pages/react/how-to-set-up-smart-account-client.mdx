...
The following sets up a Smart Account Client that will allow you to create a new smart accounts and send transactions signed by your **[Alchemy Signer](/react/getting-started)**.
