...
Be sure to check out the code and modify it to your satisfaction. And once you're ready to look closer, jump into the next section [learn how it all works](./how-it-works).
