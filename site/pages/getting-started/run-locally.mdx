...
First you can clone the repository (starter app code [here](https://github.com/alchemyplatform/embedded-accounts-quickstart)) with any of these commands:
...
You can click on the copy button to copy each of these variables to your clipboard. Fill them out in your `.env` as shown in the [`.env.sample`](https://github.com/alchemyplatform/embedded-accounts-quickstart/blob/main/.env.sample) file.
...
Be sure to check out the code and modify it to your satisfaction. And once you're ready to look closer, jump into the next section for a [walkthrough](/getting-started/walkthrough).
