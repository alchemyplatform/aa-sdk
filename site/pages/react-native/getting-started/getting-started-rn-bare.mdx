...
:::info
This guide assumes you already have a Bare React Native app and want to integrate Account Kit. If you are starting from scratch, we recommend following the [Expo guide](/react-native/getting-started/getting-started-expo) instead.
:::
