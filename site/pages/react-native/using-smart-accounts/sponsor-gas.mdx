...
Now you can follow the guide for [Sending user operations](/react-native/using-smart-accounts/send-user-operations) to send sponsored UOs from your smart account!
