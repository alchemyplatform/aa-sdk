...
`transferOwnership` is an action exported by `@account-kit/accounts` which sends a UO that transfers ownership of the account to a new owner, and returns either the UO hash or transaction hash.
