...
description: Overview of the buildUserOperationFromTxs method on SmartAccountClient
---
...
```ts
// [!include ~/../aa-sdk/core/src/actions/smartAccount/types.ts:BuildUserOperationFromTransactionsResult]
```
