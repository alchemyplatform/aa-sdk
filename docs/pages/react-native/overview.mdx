...
You can quickly spin up a new React Native (Expo) project setup with Smart Wallets by using our [quickstart template](https://github.com/alchemyplatform/account-kit-expo-quickstart).
...
This will create a new Expo project with Smart Wallets setup and ready to go! You can then follow the instructions to setup a [Signer in your project](/wallets/react-native/signer/setup-guide).
