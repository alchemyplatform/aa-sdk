...
slug: /react-native/using-smart-accounts/sponsor-gas
---
...
After [setting up Account Kit](/wallets/react-native/signer/setup-guide) in your project, follow these steps to sponsor gas.
