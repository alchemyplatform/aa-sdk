...
First, make sure you're on the latest version of Expo (SDK 52 or later). This requires React Native version 0.76 or higher because it has `TextEncoder` natively supported.
