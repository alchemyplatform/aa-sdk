...
Once you have followed the [Signer Setup Guide](/react-native/signer/setup-guide), set up and configure the Alchemy Accounts Provider in your project.
...
Now that you have set up the Alchemy Accounts Provider, you can follow the [Authentication Guides](/react-native/signer/authenticating-users/authenticating-with-otp) to learn how to authenticate users.
