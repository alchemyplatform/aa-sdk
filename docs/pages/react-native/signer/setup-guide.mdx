...
2.  Create a **new account config** in your [Account Kit Dashboard](https://dashboard.alchemy.com/accounts)
        ...
        <img
          src="/assets/images/getting-started/apply-config-to-app.png"
    ...
    If you're only using OTP auth, you can skip to step 3!
            ...
            <br />
            <img
              src="/assets/images/getting-started/email-auth-setup.png"
            ...
            <br />
            <img
              src="/assets/images/getting-started/social-auth-setup-mobile.png"
...
3.  Create the config and copy the **API Key**
    <img
      src="/assets/images/getting-started/get-api-key.png"
