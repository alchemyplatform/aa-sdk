...
You can batch transations using either the smart wallet client `sendCalls` or `prepareCalls` actions.

<CodeBlocks>

```ts twoslash title="sendCalls.ts"
import { Address, erc20Abi, encodeFunctionData, parseEther } from "viem";
