...
<Tabs>
  ...
  <Tab title="APIs">
    ...
    In the above example, we use **`ModularAccountV2`** as the underlying Smart Account type, which is our default and recommended account. To learn more about all the account options, check out our guide [**on choosing a smart account**](/wallets/smart-contracts/choosing-a-smart-account).
