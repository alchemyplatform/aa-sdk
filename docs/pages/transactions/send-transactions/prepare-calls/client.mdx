...
See the [`prepareCalls`](/wallets/reference/account-kit/wallet-client/functions/prepareCalls),
[`signPreparedCalls`](/wallets/reference/account-kit/wallet-client/functions/signPreparedCalls),
and [`sendPreparedCalls`](/wallets/reference/account-kit/wallet-client/functions/sendPreparedCalls)
