...
<Tabs>
  ...
  <Tab title="React Native">
    ## React Native Gas Sponsorship

    React Native content will be migrated here - combining content from:
    - /react-native/using-smart-accounts/sponsor-gas.mdx

    This section will include React Native specific implementation details for gas sponsorship.
  </Tab>
  <Tab title="Other JS">
    ## Set the Policy ID globally
