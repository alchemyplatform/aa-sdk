...
1. **Create a policy** in your Alchemy dashboard and configure sponsorship rules
2. **Send sponsored transactions** using your policy ID

No need to manage crypto or pre-fund accounts. Alchemy fronts the gas for your users' transactions—you pay the equivalent USD amount.
