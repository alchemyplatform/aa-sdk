...
<Info>
  Note that Cross-chain Swaps are currently only supported via direct APIs.
  JavaScript SDK and React support coming soon!
</Info>
...
<Tabs>
  ...
  <Tab title="JavaScript">Coming soon!</Tab>
...
Cross-chain swaps support multiple chain pairs. Supported chains include: Ethereum, Arbitrum, Base, Berachain, BSC/BNB, Ink, Monad, Optimism, Polygon, Unichain and World Chain mainnets. Specific supported pairs may vary.
...
Cross-chain swaps may have additional status codes beyond standard transaction statuses to reflect the cross-chain nature of the transaction. Check the status tracking documentation for details.
