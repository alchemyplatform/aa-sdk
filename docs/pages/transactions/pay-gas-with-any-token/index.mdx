...
<Accordion title="ERC-20 gas payment modes">
...
If you sponsor operations that result in dynamic amounts of the ERC-20 token left over, consider using pre-operation mode. See an example implementation below.
