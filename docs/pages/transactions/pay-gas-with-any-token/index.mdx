...
If the operation results in a static amount of the user’s token balance after execution and the developer can account for this before submitting the operation, use PostOp mode.
