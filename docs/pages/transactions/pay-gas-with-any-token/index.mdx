...
The recommended/default way to use these policies is with "post-operation" mode.
This mode requires users to hold enough of the gas token in their wallet after their operation completes to pay the gas fee.
If the balance is insufficient, the transaction reverts and you sponsor any gas used without ERC-20 payment.
