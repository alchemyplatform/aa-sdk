...
You can also use our [Get Sponsorships API](/wallets/api-reference/gas-manager-admin-api/admin-api-endpoints/get-sponsorships) to fetch the full history programmatically.
