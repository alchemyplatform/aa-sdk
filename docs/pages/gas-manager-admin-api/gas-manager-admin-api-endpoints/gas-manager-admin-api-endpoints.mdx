...
1. **Create an Alchemy app**: to create gas policies, you first need to create an Alchemy app [through your Alchemy Dashboard](https://dashboard.alchemy.com/signup).
