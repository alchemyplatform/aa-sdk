  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <p className="text-xs text-gray-500 text-center mt-4">
        No crypto wallet needed • Powered by Account Kit
      </p>
    </div>
  );
}
...
**🎉 Checkpoint:** At this point, you have a working app with social login! Users can sign in and see their smart wallet address.
...
**💡 Pro Tip:** Notice how simple transaction sending is with Account Kit! No gas estimation, no nonce management, no complex wallet connection flows.
...
- ❌ Understand gas prices and nonces

With Account Kit, users just:

- ✅ Sign in with email/social
- ✅ Use your app immediately
- ✅ Get transactions sponsored by your app
- ✅ Enjoy a Web2-like experience
