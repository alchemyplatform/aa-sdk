...
In addition, this implementation requires the developer to mantain their own security model through the management of a private key (or alternatively, several private keys) that [controls access to user accounts](https://github.com/alchemyplatform/chain-money-wallet-apis/blob/4b563fbbaebc6558aa65afbd588fb3e6699e6c2b/lib/wallet-service.ts#L123-L134).
