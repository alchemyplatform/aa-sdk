...
- Coinbase Developer Platform credentials
  - `CDP_PROJECT_ID` (get it at the [Coinbase Developer Portal](https://portal.cdp.coinbase.com/projects/api-keys))
...
Users can now click a "Buy Crypto" button in your app, complete their purchase in a popup window, and automatically return to your app with success confirmation. The crypto is sent directly to their smart wallet address.
