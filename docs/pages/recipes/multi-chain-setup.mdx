...
Once your app is configured to use multiple chains, you can switch between them at any time.
...
Use the [`useChain`](/wallets/reference/account-kit/react/hooks/useChain) hook to switch between chains:
...
Use the [`setChain`](/wallets/reference/account-kit/core/functions/setChain) function to switch between chains:
