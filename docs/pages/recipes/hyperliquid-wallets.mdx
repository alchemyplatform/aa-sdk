...
You can follow this [Quickstart](https://www.alchemy.com/docs/wallets/signer/quickstart) specifically for setting up authentication and generating a new embedded EOA with Alchemy signer. 
...
Then use `viem` to send transactions.

```tsx
import { createWalletClient, http, custom, parseEther } from 'viem'

export const walletClient = createWalletClient({
  transport: http("https://hyperliquid-mainnet.g.alchemy.com/v2/{API-KEY}"),
  chain: Hype,
