...
<Steps>
  ...
  <Step title="Environment variables">
    ...
    # Generate a secure access key for server wallet authentication - see step 2 below
    ...
    **How server wallets work:**
    ...
    <Warning>
      **Critical: Save your access key securely!**
      ...
      This access key is required to control your server wallet and cannot be recovered if lost. Make sure to add it in your .env file and store it in a secure location.
    </Warning>
  </Step>
