...
<Warning>
  ...
  [FAQs](/reference/account-abstraction-faq#what-is-a-dummy-signature-and-why-do-i-need-it-for-certain-endpoints)
  to learn what a dummy signature is and which dummy signature you should use.
</Warning>
