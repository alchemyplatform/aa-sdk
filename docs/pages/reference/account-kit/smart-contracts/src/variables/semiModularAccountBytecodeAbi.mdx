...
Defined in: [account-kit/smart-contracts/src/ma-v2/abis/semiModularAccountBytecodeAbi.ts:1](https://github.com/alchemyplatform/aa-sdk/blob/5b9429f0f16dcd4ff822527b8de589e19e88faa7/account-kit/smart-contracts/src/ma-v2/abis/semiModularAccountBytecodeAbi.ts#L1)
