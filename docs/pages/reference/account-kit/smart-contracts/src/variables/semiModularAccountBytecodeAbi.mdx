...
Defined in: [account-kit/smart-contracts/src/ma-v2/abis/semiModularAccountBytecodeAbi.ts:1](https://github.com/alchemyplatform/aa-sdk/blob/08da565ff1e1b5bcae4581d79993c4ed9e522c16/account-kit/smart-contracts/src/ma-v2/abis/semiModularAccountBytecodeAbi.ts#L1)
