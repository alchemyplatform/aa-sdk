...
Defined in: [account-kit/smart-contracts/src/msca/plugins/multisig/middleware.ts:37](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/smart-contracts/src/msca/plugins/multisig/middleware.ts#L37)
