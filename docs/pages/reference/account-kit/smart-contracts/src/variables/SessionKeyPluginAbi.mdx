...
Defined in: [account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts:540](https://github.com/alchemyplatform/aa-sdk/blob/e3c1a23e6e03f44bf2db3afddb97a91b175cba58/account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts#L540)
