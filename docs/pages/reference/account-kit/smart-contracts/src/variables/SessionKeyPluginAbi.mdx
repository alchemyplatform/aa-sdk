...
Defined in: [account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts:540](https://github.com/alchemyplatform/aa-sdk/blob/5b9429f0f16dcd4ff822527b8de589e19e88faa7/account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts#L540)
