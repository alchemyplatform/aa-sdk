...
description: Overview of the SessionKeyPluginAbi 32
slug: wallets/reference/account-kit/smart-contracts/src/variables/SessionKeyPluginAbi
layout: reference
---
...
Defined in: [account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts:540](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/smart-contracts/src/msca/plugins/session-key/plugin.ts#L540)
