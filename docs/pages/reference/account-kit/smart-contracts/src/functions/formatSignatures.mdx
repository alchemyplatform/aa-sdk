...
Defined in: [account-kit/smart-contracts/src/msca/plugins/multisig/utils/formatSignatures.ts:15](https://github.com/alchemyplatform/aa-sdk/blob/08da565ff1e1b5bcae4581d79993c4ed9e522c16/account-kit/smart-contracts/src/msca/plugins/multisig/utils/formatSignatures.ts#L15)
