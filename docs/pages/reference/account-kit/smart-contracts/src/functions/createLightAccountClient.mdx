...
Defined in: [account-kit/smart-contracts/src/light-account/clients/client.ts:41](https://github.com/alchemyplatform/aa-sdk/blob/da19afd63b0ba06a4de95b0d2d7871f64d546304/account-kit/smart-contracts/src/light-account/clients/client.ts#L41)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        `Omit`\<`CreateLightAccountParams`\<[`HttpTransport`](../../../../aa-sdk/core/src/type-aliases/HttpTransport.mdx), `TSigner`>, `"transport"`> & `Omit`\<`AlchemySmartAccountClientConfig`\<`Chain`, `LightAccount`\<`TSigner`>>, `"account"`> & `object`
      </td>
    </tr>
...
Defined in: [account-kit/smart-contracts/src/light-account/clients/client.ts:54](https://github.com/alchemyplatform/aa-sdk/blob/da19afd63b0ba06a4de95b0d2d7871f64d546304/account-kit/smart-contracts/src/light-account/clients/client.ts#L54)
