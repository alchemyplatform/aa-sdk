...
Defined in: [account-kit/infra/src/alchemyTrackerHeaders.ts:26](https://github.com/alchemyplatform/aa-sdk/blob/08da565ff1e1b5bcae4581d79993c4ed9e522c16/account-kit/infra/src/alchemyTrackerHeaders.ts#L26)
