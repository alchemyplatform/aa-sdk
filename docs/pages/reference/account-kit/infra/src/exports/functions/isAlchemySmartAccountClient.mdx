...
Defined in: [account-kit/infra/src/client/isAlchemySmartAccountClient.ts:20](https://github.com/alchemyplatform/aa-sdk/blob/49e74eee8606f480b200b4612d00d950da8a8742/account-kit/infra/src/client/isAlchemySmartAccountClient.ts#L20)
