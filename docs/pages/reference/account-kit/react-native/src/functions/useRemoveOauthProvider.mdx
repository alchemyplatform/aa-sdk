...
slug: wallets/reference/account-kit/react-native/src/functions/useRemoveOauthProvider
layout: reference
---
...
Defined in: account-kit/react/dist/types/hooks/useRemoveOauthProvider.d.ts:29
