...
slug: wallets/reference/account-kit/react-native/src/type-aliases/UseWaitForUserOperationTransactionResult
layout: reference
---
...
Defined in: account-kit/react/dist/types/hooks/useWaitForUserOperationTransaction.d.ts:10
