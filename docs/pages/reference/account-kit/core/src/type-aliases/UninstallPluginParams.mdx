...
slug: wallets/reference/account-kit/core/src/type-aliases/UninstallPluginParams
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/msca/plugin-manager/uninstallPlugin.d.ts:3
