...
slug: wallets/reference/account-kit/core/src/type-aliases/CreateWebauthnModularAccountV2Params
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/ma-v2/account/modularAccountV2.d.ts:19
