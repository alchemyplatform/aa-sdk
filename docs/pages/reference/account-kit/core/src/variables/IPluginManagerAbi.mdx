...
slug: wallets/reference/account-kit/core/src/variables/IPluginManagerAbi
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/msca/abis/IPluginManager.d.ts:1
