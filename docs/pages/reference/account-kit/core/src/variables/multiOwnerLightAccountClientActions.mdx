...
slug: wallets/reference/account-kit/core/src/variables/multiOwnerLightAccountClientActions
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/light-account/decorators/multiOwnerLightAccount.d.ts:27
