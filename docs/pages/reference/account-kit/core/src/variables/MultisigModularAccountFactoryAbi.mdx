...
slug: wallets/reference/account-kit/core/src/variables/MultisigModularAccountFactoryAbi
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/msca/abis/MultisigModularAccountFactory.d.ts:1
