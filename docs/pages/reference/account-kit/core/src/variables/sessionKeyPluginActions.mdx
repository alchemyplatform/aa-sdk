...
slug: wallets/reference/account-kit/core/src/variables/sessionKeyPluginActions
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/msca/plugins/session-key/extension.d.ts:43
