...
slug: wallets/reference/account-kit/core/src/variables/getDefaultMultiOwnerLightAccountFactoryAddress
layout: reference
---

```ts
const getDefaultMultiOwnerLightAccountFactoryAddress: (
  chain,
  version,
) => `0x${string}`;
```
