...
slug: wallets/reference/account-kit/core/src/variables/IAccountLoupeAbi
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/msca/abis/IAccountLoupe.d.ts:1
