...
Defined in: [account-kit/core/src/store/store.ts:378](https://github.com/alchemyplatform/aa-sdk/blob/08da565ff1e1b5bcae4581d79993c4ed9e522c16/account-kit/core/src/store/store.ts#L378)
