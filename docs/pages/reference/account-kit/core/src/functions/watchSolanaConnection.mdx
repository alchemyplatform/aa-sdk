...
slug: wallets/reference/account-kit/core/src/functions/watchSolanaConnection
layout: reference
---
...
Defined in: [account-kit/core/src/actions/watchSolanaConnection.ts:18](https://github.com/alchemyplatform/aa-sdk/blob/da19afd63b0ba06a4de95b0d2d7871f64d546304/account-kit/core/src/actions/watchSolanaConnection.ts#L18)
