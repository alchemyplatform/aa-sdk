...
slug: wallets/reference/account-kit/core/src/functions/predictModularAccountV2Address
layout: reference
---
...
Defined in: account-kit/smart-contracts/dist/types/src/ma-v2/account/predictAddress.d.ts:39
