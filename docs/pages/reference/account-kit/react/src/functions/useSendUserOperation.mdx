...
Defined in: [account-kit/react/src/hooks/useSendUserOperation.ts:127](https://github.com/alchemyplatform/aa-sdk/blob/da19afd63b0ba06a4de95b0d2d7871f64d546304/account-kit/react/src/hooks/useSendUserOperation.ts#L127)
