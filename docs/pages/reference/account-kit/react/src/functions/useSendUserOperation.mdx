...
Defined in: [account-kit/react/src/hooks/useSendUserOperation.ts:127](https://github.com/alchemyplatform/aa-sdk/blob/08da565ff1e1b5bcae4581d79993c4ed9e522c16/account-kit/react/src/hooks/useSendUserOperation.ts#L127)
