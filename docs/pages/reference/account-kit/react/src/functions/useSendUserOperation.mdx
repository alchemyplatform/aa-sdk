...
slug: wallets/reference/account-kit/react/src/functions/useSendUserOperation
layout: reference
---
...
Defined in: [account-kit/react/src/hooks/useSendUserOperation.ts:127](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/react/src/hooks/useSendUserOperation.ts#L127)
