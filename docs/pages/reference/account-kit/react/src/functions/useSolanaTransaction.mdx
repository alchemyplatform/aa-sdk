...
Defined in: [account-kit/react/src/hooks/useSolanaTransaction.ts:124](https://github.com/alchemyplatform/aa-sdk/blob/5b9429f0f16dcd4ff822527b8de589e19e88faa7/account-kit/react/src/hooks/useSolanaTransaction.ts#L124)
