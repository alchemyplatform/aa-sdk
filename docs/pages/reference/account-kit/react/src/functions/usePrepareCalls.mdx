...
Defined in: [account-kit/react/src/hooks/usePrepareCalls.ts:88](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/react/src/hooks/usePrepareCalls.ts#L88)
...
| :-------- | :------------------------------------------------------------------- | :------------------------------------ |
| `params`  | [`UsePrepareCallsParams`](../type-aliases/UsePrepareCallsParams.mdx) | Configuration parameters for the hook |
