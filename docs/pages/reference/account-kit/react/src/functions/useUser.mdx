---
title: useUser
description: Overview of the useUser function
slug: wallets/reference/account-kit/react/src/functions/useUser
layout: reference
---
...
Defined in: [account-kit/react/src/hooks/useUser.ts:29](https://github.com/alchemyplatform/aa-sdk/blob/e3c1a23e6e03f44bf2db3afddb97a91b175cba58/account-kit/react/src/hooks/useUser.ts#L29)
