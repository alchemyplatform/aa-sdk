...
Defined in: [account-kit/react/src/configForExternalWallets.ts:56](https://github.com/alchemyplatform/aa-sdk/blob/e3c1a23e6e03f44bf2db3afddb97a91b175cba58/account-kit/react/src/configForExternalWallets.ts#L56)
