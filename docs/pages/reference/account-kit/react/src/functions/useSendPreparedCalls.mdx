...
Defined in: [account-kit/react/src/hooks/useSendPreparedCalls.ts:86](https://github.com/alchemyplatform/aa-sdk/blob/4987bdd63823427c48ec21401b71fa3cfc2d0675/account-kit/react/src/hooks/useSendPreparedCalls.ts#L86)
