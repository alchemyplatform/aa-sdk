...
slug: wallets/reference/account-kit/react/src/functions/useSignMessage
layout: reference
---
...
Defined in: [account-kit/react/src/hooks/useSignMessage.ts:73](https://github.com/alchemyplatform/aa-sdk/blob/49e74eee8606f480b200b4612d00d950da8a8742/account-kit/react/src/hooks/useSignMessage.ts#L73)
...
| :-------- | :------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config`  | [`UseSignMessageArgs`](../type-aliases/UseSignMessageArgs.mdx) | The configuration arguments for the hook, including the client and additional mutation arguments. [ref](https://github.com/alchemyplatform/aa-sdk/blob/main/account-kit/react/src/hooks/useSignMessage.ts#L25) |
