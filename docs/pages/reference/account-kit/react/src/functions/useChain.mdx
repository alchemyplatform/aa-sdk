...
Defined in: [account-kit/react/src/hooks/useChain.ts:51](https://github.com/alchemyplatform/aa-sdk/blob/5b9429f0f16dcd4ff822527b8de589e19e88faa7/account-kit/react/src/hooks/useChain.ts#L51)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        `Partial`\<`Omit`\<`UseMutationOptions`\<`void`, `Error`, \{ `chain`: `Chain`; }, `unknown`>, `"mutationFn"` | `"mutationKey"`>>
      </td>
