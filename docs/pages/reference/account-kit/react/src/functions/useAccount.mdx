...
Defined in: [account-kit/react/src/hooks/useAccount.ts:54](https://github.com/alchemyplatform/aa-sdk/blob/5b9429f0f16dcd4ff822527b8de589e19e88faa7/account-kit/react/src/hooks/useAccount.ts#L54)
