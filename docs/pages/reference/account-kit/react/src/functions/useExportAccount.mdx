...
description: Overview of the useExportAccount function
slug: wallets/reference/account-kit/react/src/functions/useExportAccount
layout: reference
---
...
Defined in: [account-kit/react/src/hooks/useExportAccount.ts:68](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/react/src/hooks/useExportAccount.ts#L68)
