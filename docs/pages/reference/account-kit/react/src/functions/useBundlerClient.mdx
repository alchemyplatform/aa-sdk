...
Defined in: [account-kit/react/src/hooks/useBundlerClient.ts:25](https://github.com/alchemyplatform/aa-sdk/blob/923a52171f7246172caf350853843e6680197da9/account-kit/react/src/hooks/useBundlerClient.ts#L25)
