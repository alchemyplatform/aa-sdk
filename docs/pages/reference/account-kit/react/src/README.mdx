...
description: Overview of account-kit/react/src
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [NoAlchemyAccountContextError](classes/NoAlchemyAccountContextError.mdx)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [cookieStorage](variables/cookieStorage.mdx)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        [AuthCard](functions/AuthCard.mdx)
      </td>
    ...
    <tr>
      <td>
        [configForExternalWallets](functions/configForExternalWallets.mdx)
      </td>
    ...
    <tr>
      <td>
        [useAlchemyAccountContext](functions/useAlchemyAccountContext.mdx)
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        **Throws**
        ...
        Will throw an error if the hook is not used within an `AuthModalProvider` or if the current auth step type does not match the expected type
      </td>
    </tr>
    ...
    <tr>
      <td>
        [useAuthModal](functions/useAuthModal.mdx)
      </td>
    ...
    <tr>
      <td>
        [useBundlerClient](functions/useBundlerClient.mdx)
      </td>
    ...
    <tr>
      <td>
        [useCallsStatus](functions/useCallsStatus.mdx)
      </td>
    ...
    <tr>
      <td>
        [useConnect](functions/useConnect.mdx)
      </td>
    ...
    <tr>
      <td>
        [useGrantPermissions](functions/useGrantPermissions.mdx)
      </td>
    ...
    <tr>
      <td>
        [useListAuthMethods](functions/useListAuthMethods.mdx)
      </td>
    ...
    <tr>
      <td>
        [usePrepareCalls](functions/usePrepareCalls.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSendCalls](functions/useSendCalls.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSendPreparedCalls](functions/useSendPreparedCalls.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSigner](functions/useSigner.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSignerStatus](functions/useSignerStatus.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSmartWalletClient](functions/useSmartWalletClient.mdx)
      </td>
    ...
    <tr>
      <td>
        [useSolanaSignMessage](functions/useSolanaSignMessage.mdx)
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        **Throws**
        ...
        Will throw an error if the `UiConfigContext` is not present in the component tree
    ...
    <tr>
      <td>
        [useWaitForCallsStatus](functions/useWaitForCallsStatus.mdx)
      </td>
