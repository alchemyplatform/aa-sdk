...
slug: /reference/account-kit/react/hooks/useAddPasskey
---
...
`UseAddPasskeyResult`
An object containing the `addPasskey` function, a boolean `isAddingPasskey` to track the mutation status, and any error encountered. [ref](https://github.com/alchemyplatform/aa-sdk/blob/main/account-kit/react/src/hooks/useAddPasskey.ts#L13)
