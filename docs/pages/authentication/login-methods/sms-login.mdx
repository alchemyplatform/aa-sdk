...
<Tabs>
    <Tab title="React">
        <Info>
        SMS auth is not yet supported with pre-built UI components. Please follow [this guide](/wallets/react/react-hooks) to set up custom UI and configure authentication with hooks.
        </Info>
