...
Once your users have been authenticated, you can start [sending transactions](/wallets/transactions/send/send-user-operations).

### Sponsor Gas for Transactions

Start [sponsoring gas fees](/wallets/transactions/sponsor-gas/sponsor-gas) for transactions.
