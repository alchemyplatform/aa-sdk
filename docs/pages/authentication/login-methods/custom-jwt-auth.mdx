...
slug: wallets/authentication/login-methods/custom-jwt-auth
---

Custom JWT authentication enables you to integrate your existing OIDC-compliant authentication system with Alchemy Smart Wallets. Users can maintain their familiar login experience while gaining access to smart wallet functionality.
...
<Note>
  You can obtain the audience claim from your Smart Wallet configuration in the
  [Alchemy
  Dashboard](https://dashboard.alchemypreview.com/services/smart-wallets/configuration).
</Note>
...
Enhance security by adding [Multi-Factor Authentication](/wallets/react/mfa/setup-mfa) to your JWT authentication flow.

### Session Management

Learn about [User Sessions](/wallets/signer/user-sessions) to manage authenticated user state.

### Smart Account Features

Explore advanced features like [Session Keys](/wallets/smart-contracts/modular-account-v2/session-keys/) and [Gas Sponsorship](/wallets/react/sponsor-gas).
