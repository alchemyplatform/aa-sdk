...
1. [`AlchemyWebSigner`](/wallets/reference/account-kit/signer/classes/AlchemyWebSigner) - This is an implementation of the `SmartAccountAuthenticator` that uses the our signer service to roviion private keys securely
