...
## Why Seemless Authentication Matters in Web3
...
A [**Signer**](/wallets/signer/what-is-a-signer) is the service or application that manages private keys and signs operations for your users. Smart Wallets is designed to be flexible and allow you to use any Signer you want, including:
