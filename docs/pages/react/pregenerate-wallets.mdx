...
- Alchemy **API Key** with Smart Wallets enabled
  ...
  - Existing api keys can be found in the Alchemy Dashboard by viewing your config in the [Smart wallets configuration page](https://dashboard.alchemy.com/signup)
