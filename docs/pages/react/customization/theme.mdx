---
title: Custom theme
description: Learn how to customize the theme of the Smart Wallets React components
...
Most theme customizations are passed through using `withAccountKitUi`, the Smart Wallets Tailwind plugin, in your `tailwind.config.js` file.
