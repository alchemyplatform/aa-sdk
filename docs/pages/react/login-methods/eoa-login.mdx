---
title: Seamlessly Connect to Existing EOA Wallets
description: How to connect to other wallet providers using Account Kit
---

## Seamlessly Connect to Existing EOA Wallets
...
## Custom UI
If you need complete control over the user experience, you can implement your own EOA connect using custom UI or our pre-built UI components and connectors:
...
## Connect to Existing Embedded EOA Wallets
You can also (bring in your embedded EOAs!)[https://www.alchemy.com/docs/wallets/third-party/signers#using-walletclientsigner]