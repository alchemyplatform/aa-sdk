...
To bring in your own **public/private key pair** and use it as a signer in Account Kit, you can manually implement the `SmartAccountSigner` interface. More info [here](https://www.alchemy.com/docs/wallets/third-party/signers).
