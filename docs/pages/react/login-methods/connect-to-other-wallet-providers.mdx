...
<Tip>
  With Account Kit, users can still connect to their existing wallets without
  sacrificing compatibility or convenience.
</Tip>

<img src="/images/connect-to-other-wallet-providers" />
