---
title: Getting started with authenticationss
description: Setting up your React application to use Account Kit authentication
slug: wallets/react/getting-started
---

Account Kit makes it really easy to authenticate your users using a number of different authentication methods. If you followed the [quickstart](/wallets/react/quickstart), then your app is already setup to authenticate users and you can skip this guide!
