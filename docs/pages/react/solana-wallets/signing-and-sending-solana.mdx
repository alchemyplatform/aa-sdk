...
For collaborative workflows and DAO interactions, please refer to the documentation for PDA construction on the Squad Wallet website. For shared treasury use cases, see the Squad Wallet documentation or NPM SDK.
