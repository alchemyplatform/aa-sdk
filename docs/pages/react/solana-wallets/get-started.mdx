...
If you're not using React, use lower level libraries to convert your Alchemy signer instance into a Solana-compatible signer using the `SolanaSigner` class. [See Signer Solana docs](/wallets/reference/account-kit/signer/classes/SolanaSigner/constructor).
