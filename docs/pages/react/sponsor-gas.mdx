...
slug: wallets/react/sponsor-gas
---
...
After [setting up Smart Wallets](/wallets/react/quickstart) in your project, follow these steps to sponsor gas.
...
When creating your Smart Wallets config, you can optionally pass in a Gas Policy ID. This will enable all UOs sent by the `useSendUserOperation` hook to be sponsored by the policy you created.
