...
description: Learn how to integrate Alchemy Account Kit into your existing React application with embedded wallets and authentication.
text: Add to Existing Project
link: /react/quickstart/integration
slug: wallets/react/quickstart/integration
---
...
<Tip>
  **Using Tailwind v3?** If you're still using Tailwind v3, you can skip the
  setup above since you've already configured it.
</Tip>

## 2. Get your API Key

1. Go to the [Alchemy Dashboard](https://dashboard.alchemy.com/accounts)
...
export const metadata: Metadata = {
  ...
  description: "My app with Alchemy Account Kit integration",
};
