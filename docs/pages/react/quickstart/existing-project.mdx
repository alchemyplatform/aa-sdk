...
export default withAccountKitUi(
  ...
  {
    // Smart Wallets UI theme customizations
  },
);
```
...
<CardGroup cols={2}>
  <Card title="Send Transactions" icon={<img src="https://static.alchemyapi.io/images/docs/right_arrow.svg" alt="Send Transactions"/>} href="/wallets/transactions/send/send-user-operations">
