...
<CardGroup cols={2}>
  ...
  <Card title="Add Gas Sponsorship" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Gas Sponsorship"/>} href="/wallets/transactions/sponsor-gas/sponsor-gas">
