...
<CardGroup cols={2}>
  ...
  <Card title="Customize UI Components" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Customize UI"/>} href="/wallets/react/ui-components">
