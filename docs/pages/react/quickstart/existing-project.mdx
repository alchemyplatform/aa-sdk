...
<CardGroup cols={2}>
  ...
  <Card title="Customize UI Components" icon={<img src="https://static.alchemyapi.io/images/docs/right_arrow.svg" alt="Customize UI"/>} href="/wallets/react/ui-components">
    Customize and style the UI components to match your application's design.
  </Card>

  <Card title="Add Gas Sponsorship" icon={<img src="https://static.alchemyapi.io/images/docs/right_arrow.svg" alt="Gas Sponsorship"/>} href="/wallets/transactions/sponsor-gas/sponsor-gas">
    Enable gasless transactions by setting up gas sponsorship for your users.
  </Card>

  <Card title="Multi-Factor Authentication" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="MFA"/>} href="/wallets/react/mfa/setup-mfa">
