...
Note:
This is set up allows you to connect to other existing external EOAs such as MetaMask using our built-in connectors and WalletConnect. Learn more [here](/wallets/react/login-methods/eoa-login)
