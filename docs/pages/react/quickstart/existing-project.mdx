...
Account Kit requires Tailwind CSS to be properly configured. For detailed setup instructions, see the [complete Tailwind setup guide](/wallets/react/tailwind-setup).

<Tip>
  **Already using Tailwind?** Check the [Tailwind setup guide](/wallets/react/tailwind-setup#existing-tailwind-installation) for instructions on integrating Account Kit with your existing Tailwind configuration.
</Tip>
...
For complete Tailwind configuration instructions including `tailwind.config.ts` setup, CSS imports, and theme customization options, see the [Tailwind setup guide](/wallets/react/tailwind-setup).
...
- [Send user operations](/wallets/transactions/send/send-user-operations) to perform transactions
- [Customize your UI components](/wallets/react/ui-components) for advanced styling
- [Add gas sponsorship](/wallets/transactions/sponsor-gas/sponsor-gas) for gasless transactions
