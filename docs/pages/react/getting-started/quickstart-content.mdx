...
Create an app with embedded wallets, social login and ability to send sponsored transactions.
...
Create a [`Configuration`](https://dashboard.alchemy.com/services/smart-wallets/configuration) and a [`Gas Sponsorship Policy`](https://dashboard.alchemy.com/services/gas-manager/configuration) to use Smart Wallets.
...
- Swaps [(Get Early Access!)](/docs/wallets/transactions/swap-tokens)
