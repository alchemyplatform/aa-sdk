...
Remember: you must create a [`Configuration`](https://dashboard.alchemy.com/services/smart-wallets/configuration) and a [`Gas Manager Policy`](https://dashboard.alchemy.com/services/gas-manager/configuration) if you want to use Smart Wallets.
