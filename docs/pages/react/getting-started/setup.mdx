...
3. Optional: Modify the newly created configuration according to your specific needs according to the See the [Authentication Setup guide](/wallets/authentication/setup) to enable login methods and configure authentication.

4. Create a policy in your [gas manager dashboard](https://dashboard.alchemy.com/services/gas-manager/configuration) to set rules for sponsorship.
