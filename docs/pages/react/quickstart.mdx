...
```bash yarn
yarn create next-app account-kit-app -e https://github.com/alchemyplatform/smart-wallets-quickstart
```
...
Set up a paymaster policy to sponsor gas for your smart wallets. If you want more information on how to set up a paymaster policy, see the [Sponsor gas docs](https://www.alchemy.com/docs/wallets/core/sponsor-gas).

1. Go to the [Alchemy Dashboard](https://dashboard.alchemy.com/)
2. Navigate to **Wallets** → **Gas Manager**
