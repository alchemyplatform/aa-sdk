...
<CodeBlocks>
  ```bash npx create-next-app my-smart-wallets-app -e
  https://github.com/alchemyplatform/smart-wallets-quickstart cd
...
<CodeBlocks>
  ```shell # Paste this in your .env file
...
<CodeBlocks>```bash npm run dev ```</CodeBlocks>
