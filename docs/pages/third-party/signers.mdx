...
Smart accounts in Smart Wallets expect an implementation of `SmartAccountSigner` to work in Smart Wallets. We also include a `SmartAccountAuthenticator` interface that extends `SmartAccountSigner` and wraps any SDKs you can use as part of the implementation of your own Signer.
