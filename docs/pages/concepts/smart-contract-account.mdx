...
description: What is a smart contract account in Smart Wallets?
slug: wallets/concepts/smart-contract-account
---

The [`SmartContractAccount`](#TODO/link-to-type) interface within Smart Wallets is the client-side definition of an on-chain smart contract implementation.
