...
<Tip>
  If you're using the [React](/react/overview) or [Core](/core/overview)
  packages, the Smart Account Clients already handle hoisting and creation of
  account instances. The [Smart Contracts](/smart-contracts/overview) package
  exports client definitions for hoisted instances of the Smart Contract
  Accounts.
</Tip>
