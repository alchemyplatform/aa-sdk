...
<Warning>
  ...
  (relative paths for network RPC
  requests)[https://github.com/alchemyplatform/aa-sdk/blob/005ad7abbe3e173ed9f4a9d93a9b39d0462abc1c/examples/ui-demo/src/app/api/rpc/%5B...routes%5D/route.ts#L21],
  relative paths for signer API requests, and (network-agnostic RPC
  requests)[https://github.com/alchemyplatform/aa-sdk/blob/005ad7abbe3e173ed9f4a9d93a9b39d0462abc1c/examples/ui-demo/src/app/api/rpc/route.ts#L20]
