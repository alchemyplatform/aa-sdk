...
<Accordion title="Answer">
  ...
  it when you create [light
  account](/wallets/smart-contracts/other-accounts/light-account/getting-started).
</Accordion>
...
<Accordion title="Answer">
  ...
  conversions, the service handles this! You can follow [this
  guide](/wallets/gas-manager-admin-api/how-to-sponsor-gas-on-evm) for more
  details on how to sponsor transactions.
</Accordion>
...
<Accordion title="Answer">
  ...
  [here](/wallets/gas-manager-admin-api/gas-manager-admin-api-endpoints/gas-manager-admin-api-endpoints).
</Accordion>
