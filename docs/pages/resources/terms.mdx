...
The Smart Wallets framework is designed to embed smart accounts in web3 applications. It includes a set of tools such as [Signer integrations](/wallets/concepts/smart-account-signer), [Gas Manager](https://docs.alchemy.com/docs/gas-manager-services) and [Bundler](https://docs.alchemy.com/docs/bundler-services) utilities that unlock features such as [gas sponsorship](/wallets/transactions/sponsor-gas/sponsor-gas-evm), [batched transactions](/wallets/transactions/send-batch-transactions) and email/social login. With its user-friendly suite of SDKs, known as [aa-sdk](https://github.com/alchemyplatform/aa-sdk), Smart Wallets makes it easy to deploy smart accounts, manage `UserOperation`s, and handle gas sponsorship, streamlining the entire process with minimal coding effort.
