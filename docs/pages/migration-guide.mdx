...
These methods have been removed since `useSendUserOperation` can be used to send transactions and transactions. If you were using `useSendTransaction` or `useSendTransactions`, you can replace them with
