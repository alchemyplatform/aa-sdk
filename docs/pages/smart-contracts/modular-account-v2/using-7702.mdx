...
Now that you have an EOA successfully upgraded and a smart account clinet, you can use advanced features like batching transactions and more. Explore what else you can do with smart accounts [here](/docs/wallets/transactions/send/send-user-operations).
