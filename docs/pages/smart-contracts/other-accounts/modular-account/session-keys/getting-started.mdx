...
See the [Supported Permissions](/smart-contracts/other-accounts/modular-account/session-keys/supported-permissions#using-the-permissionsbuilder) page for more information on how to used the permissions builder.
