...
description: Follow this guide to use Modular Accounts with Smart Wallets, a
...
Read more about Multi Owner Plugin and how to get started with Modular Account [here](/wallets/smart-contracts/other-accounts/modular-account/manage-ownership-mav1)!
...
Read more about installing and using the Session Key plugin [here](/wallets/smart-contracts/other-accounts/modular-account/session-keys)!
...
Read more about Multisig Plugin [here](/wallets/smart-contracts/other-accounts/modular-account/multisig-plugin/)!
