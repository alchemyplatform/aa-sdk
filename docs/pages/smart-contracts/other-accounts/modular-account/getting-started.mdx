...
To learn how to add and remove plugins (for example, installing the Session Key Plugin), see the guide on [Installing & uninstalling plugins](/wallets/smart-contracts/other-accounts/modular-account/manage-plugins/install-plugins).
