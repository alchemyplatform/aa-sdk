...
slug: wallets/infra/overview
---

The `@account-kit/infra` package provides client and middleware definitions for interacting with our ERC-4337 infrastructure. It makes it really easy to use just our infra (gas manager and bundler RPC) if you'd like more control over which smart contracts or signer you're using. The guides in this section of the
