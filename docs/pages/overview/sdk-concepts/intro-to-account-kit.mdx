...
<div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start" }}>
  <div style={{ flex: "1", marginRight: "10px" }}>
With gas sponsorship, your users won't need to worry about having assets in their accounts to pay for gas. Using [Smart Wallets](/wallets/transactions/sponsor-gas/sponsor-gas), simply configure a gas manager policy, insert your policy ID into the SDK, and let our Gas Manager handle the rest.
