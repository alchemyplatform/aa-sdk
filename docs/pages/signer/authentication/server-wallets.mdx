...
const client = createSmartWalletClient({
  ...
  chain: baseSepolia,
  signer,
  policyId: "your-gas-manager-policy-id", // Make sure enabled on Base Sepolia
});
...
Your server signer can also be used with Solana by converting it to a Solana signer. To start sending sponsored Solana transactions, make sure to set up a Solana gas manager policy in our [dashboard](https://dashboard.alchemy.com/gas-manager).
