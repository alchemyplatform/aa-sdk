...
If using an Alchemy Signer, you can learn how to stamp the request on the frontend [here](https://docs.alchemy.com/reference/how-to-stamp-requests). When using the Alchemy Signer, it's easiest to sign the `signatureRequest.rawPayload` directly.
