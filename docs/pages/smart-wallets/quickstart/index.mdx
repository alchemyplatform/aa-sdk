...
You can complete this tutorial using either the [TypeScript SDK](/docs/wallets/smart-wallet-quickstart/sdk) or raw [JSON-RPC APIs](/docs/wallets/smart-wallet-quickstart/api).

<CardGroup cols={2}>
  <Card
    title="Using SDK"
    href="/docs/wallets/smart-wallet-quickstart/sdk"
    icon="code"
  >
  ...
  <Card
    ...
    href="/docs/wallets/smart-wallet-quickstart/api"
    icon="network-wired"
  >
