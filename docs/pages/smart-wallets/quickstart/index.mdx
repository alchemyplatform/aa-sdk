...
You can complete this tutorial using either the [TypeScript SDK](/docs/reference/smart-wallet-quickstart/sdk) or raw [JSON-RPC APIs](/docs/reference/smart-wallet-quickstart/api).

<CardGroup cols={2}>
  <Card
    title="Using SDK"
    href="/docs/reference/smart-wallet-quickstart/sdk"
    icon="code"
  >
  ...
  <Card
    ...
    href="/docs/reference/smart-wallet-quickstart/api"
    icon="network-wired"
  >
