...
The logical flow is to get an account for a given signer, prepare the calls you’re looking to send, and send them! If you're looking for a TypeScript SDK guide, you'll find that here too.
