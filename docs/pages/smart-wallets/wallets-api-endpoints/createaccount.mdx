...
**Using React or Vanilla JS?** Use our [Smart Wallets SDK](https://accountkit.alchemy.com/) to create and use wallets. The SDK handles all signing and authentication complexity for you, making development faster and easier. We provide an [SDK](https://github.com/alchemyplatform/aa-sdk) in React, Vanilla Typescript, and (soon) Java.
