...
You can follow along using either the [TypeScript SDK](/reference/wallet-apis-7702-quickstart/sdk) or platform-agnostic [JSON-RPC APIs](/reference/wallet-apis-7702-quickstart/api).
