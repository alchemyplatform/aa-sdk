...
We'll demonstrate how to create and use session keys [using the SDK client](/reference/wallet-apis-session-keys/sdk) or by using platform-agnostic [JSON-RPC APIs](/reference/wallet-apis-session-keys/api).

<CardGroup cols={2}>
  <Card
    title="Use the SDK"
    href="/reference/wallet-apis-session-keys/sdk"
    icon="code"
  >
  ...
  <Card
    ...
    href="/reference/wallet-apis-session-keys/api"
    icon="network-wired"
  >
