...
- **`policyId`** (string) - [Gas Manager Policy ID](https://dashboard.alchemy.com/signup) that enables gas sponsorship within policy limits
...
| Sponsor gas for users. Get your policy ID [here](https://dashboard.alchemy.com/signup)                                                                                                   | `policyId`          | `string`                                                                                                                                                                                                                                                                                             |
