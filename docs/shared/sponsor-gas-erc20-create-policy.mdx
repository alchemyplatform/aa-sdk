...
- Receiving address: **you must specify** an address of your choosing where the users' ERC20 tokens will be sent to as they pay for gas. The token transfer to this address is orchestrated by the paymaster contract and happens automatically at transaction time.
