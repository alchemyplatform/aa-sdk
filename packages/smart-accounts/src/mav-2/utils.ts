import type { UpgradeToData } from "@aa-sdk/core";
import {
  concatHex,
  toHex,
  type Address,
...
export const getDefaultMAV2FactoryAddress = (chain: Chain): Address => {
  // TODO(jh): do we really need this if it's the same on all chains? should we do similar to LightAccount?
  switch (chain.id) {
    default:
...
// TODO(jh): is this okay or do we need to pass a client like we used to? add jsdoc & example.
...
// TODO(jh): why is this erc-20 stuff here?
...
// TODO(jh): do we really need these for modules? or should they just be consts w/ overrides?
