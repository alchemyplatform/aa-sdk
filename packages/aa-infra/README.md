...
This package, along with `@alchemy/common`, replaces `@account-kit/infra`. This is a low-level package. Most users should use [`@alchemy/wallet-apis`](https://www.alchemy.com/docs/wallets/reference/wallet-apis) unless you need to call bundler or paymaster RPCs directly via viem.
