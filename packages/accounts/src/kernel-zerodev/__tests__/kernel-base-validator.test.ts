...
describe("Base Validator Test", () => {
    ...
    it("should sign hash properly", async () => {
        expect(await validator.signMessageWithValidatorParams("0xabcfC3DB1e0f5023F5a4f40c03D149f316E6A5cc")).eql(
    ...
    it("should sign hash properly without 0x", async () => {
        expect(await validator.signMessageWithValidatorParams("icanbreakthistestcase")).eql(
    ...
    it("should return proper validation signature", async () => {
        expect(await validator.signMessageWithValidatorParams("0xbc7299170f076afcbafe11da04482e72e3beccabcd82de0cd2797500e81b76c4")).eql(
