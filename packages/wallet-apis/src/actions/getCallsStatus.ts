...
export type GetCallsStatusParams = Prettify<
  Static<typeof wallet_getCallsStatus>["Request"]["params"][0]
>;

export type GetCallsStatusResult = Prettify<
  Static<typeof wallet_getCallsStatus>["ReturnType"]
>;
